...
function PlatformGroup({
  ...
  const borderColor = accent === "blue" ? "border-blue-100" : accent === "orange" ? "border-orange-100" : "border-teal-100";
  const bgBadge    = accent === "blue"   ? "from-blue-500 to-indigo-600"
                   : accent === "orange" ? "from-orange-500 to-red-500"
                   : "from-teal-500 to-emerald-600";
  const textLabel  = accent === "blue" ? "text-blue-700" : accent === "orange" ? "text-orange-700" : "text-teal-700";
  return (
